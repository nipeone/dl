...
parser.add_argument('--path', default="", type=str, help='ckpt path')
parser.add_argument('--model', default="resnet", type=str, help='model name')
parser.add_argument('--count', default=1, type=int, help='tta eval count')
...
print ('available gpu num is ' + str(gpu_nums))
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['test']:
            ...
            for idx,data in enumerate(dataloaders[phase]):
                ...
                all_softlabels.append(outputs.clone().data.cpu().numpy())
...
if __name__ == '__main__':
    ...
    model_ft = recursion_original_module(checkpoint['net'])
    ...
    #checkpoints = []
    #densenet169
    #checkpoints.append(torch.load("./checkpoint/ckpt.t70_20180928"))
    #resnet152
