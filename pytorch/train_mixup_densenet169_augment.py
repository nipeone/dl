...
data_dirs={"train":"/home/gfkd/bito8/augment_images","val":"/home/gfkd/bito8/validation_dir"}
...
if args.resume:
    ...
    net.classifier = nn.Linear(num_ftrs, num_class)
...
def save_per_epoch(acc,epoch):
    ...
    if not os.path.isdir("checkpoint/epochs"):
        os.mkdir('checkpoint/epochs')
    torch.save(state,'./checkpoint/epochs/ckpt.t7' + args.name + '_' 
               + str(args.seed)+"_epoch_"+str(epoch))
